...
import {DatePicker,List, Toast, InputItem,} from 'antd-mobile';
...
function FormRender({
    ...
    async function submitAPI(params) {
        ...
        let params_service = {
            service: BASE_URL + `/microActivity/addSubscribe`,
            data: params,
        }
        
        return requestData(`/thinknode-dd/dingding/activity/post`, {
            method: 'post',
            headers: {
