...
import styles from './AccountUntieLoginComponent.less';
import { Button , InputItem ,ActivityIndicator , Toast} from 'antd-mobile';
import {createForm} from 'rc-form';

function AccountUntieLoginComponent({
	 form: {
    	getFieldProps,
        validateFields,
        getFieldsValue,
	...
	return(
        <div style={{height:'100%'}}>
            ...
            <div className='accountBind'>
                ...
                <div className={styles.logo_tip}>- 解绑您的收银宝账号 -</div>
                <InputItem
                ...
                <Button type="primary" className={styles.sure_btn} onClick={sureFunc}>解&nbsp;绑</Button>
            </div>
         </div>
    );
}
...
export default createForm()(AccountUntieLoginComponent);
