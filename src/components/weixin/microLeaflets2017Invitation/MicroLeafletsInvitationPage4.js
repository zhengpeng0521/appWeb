		...
		<div className="js_invitation">
				{
					...
					? 
						<div className={styles.base_content}>
							<div>
								<p className={styles.page4_title}>{data.title || ''}</p>
								<div className={styles.page4_cover1} style={{backgroundImage : url1}}></div> 
								<div className={styles.page4_cover2} style={{backgroundImage : url2}}></div> 
								<div className={styles.page4_image1}></div> 
								<div className={styles.page4_image2}></div> 
								<div className={styles.page4_image3}></div> 
							</div> 
						</div>
					: ''
				}
