...
function YuanxiaoActivity({
	...
	function subUserData() {
		_hmt.push(['_trackEvent', '微活动2017元宵预约', `点击了预约按钮`, ``, '-']);
		submitUserDataFunction(babyName, babyPhone);
	};

    return(
			<div className="yuanxiao_div">
				<div className={styles.background6} style={{height : HEIGHT_MIN * 100}}>
					...
					<div className={styles.inputbackground_submit} onClick={subUserData}>
                        <p className={styles.background6_submit_button}>提 交</p>
                    </div>
